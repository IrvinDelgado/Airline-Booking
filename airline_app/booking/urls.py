...
urlpatterns = [
    ...
    path('<str:userEmail>/flightsBought', views.flightsBought, name ='flightsBought'),
    path('<str:userEmail>/deleteFlight/<str:booking_id>', views.deleteFlight, name ='deleteFlight'),
]
